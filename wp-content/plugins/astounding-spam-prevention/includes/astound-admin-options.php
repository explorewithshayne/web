  ...
  <div id="astoundd0">
	...
	<?php if ($astound_chkdnsbl=='Y') {?>checked="checked"<?php } ?> onclick="astoundProcess(this)">
          ...
          <td><em><b>Check zen.spamhaus.org Black List</b></em><br>
			...
			Spamhaus is one the largest and most comprehensive spam blacklists. This is a check on a users internet address to see if Spamhaus sees the user as a spammer.</td>
        </tr>
        <tr>
          <td width="50px" align=left><label class="switch">
